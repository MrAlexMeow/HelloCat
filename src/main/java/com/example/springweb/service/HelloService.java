...
public class HelloService {
    ...
    public String login(String name,String password){
        return helloMapper.login(name,password);
    }

    public void update_type(int id,String type){
        helloMapper.update_type(type,id);
    }
    public void update_name(int id,String get_name){
        helloMapper.update_name(get_name,id);
    }
    public void update_grade(int id,String applied_range){
        helloMapper.update_grade(applied_range, id);
    }

    public void update_safety_level(int id,String safety_level){
        helloMapper.update_safety_level(safety_level, id);
    }
    public String safety(int id){
        return helloMapper.safety(id);
    }
    public String get_name(int id){
        return helloMapper.get_name(id);
    }
    public String grade(int id){
        return helloMapper.grade(id);
    }
    public String type(int id){
        return helloMapper.type(id);
    }
}
